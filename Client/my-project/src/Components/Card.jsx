  ...
  return (
    <>
      <div className="bg-bgColor flex flex-col justify-center items-center  gap-y-8 container pb-10 ml-2 w-[80vw] md:w-[60vmin] 2xl:w-[50vmin] mt-2 border-[1px] rounded-2xl p-2">
        <div className="bg-white p-2 border-bannerGrey border-[1px] container h-[35vmin] w-[50vmin]  rounded-2xl mt-4 flex justify-center items-center ">
          <img
            src={props.image}
        ...
        <div>
          <p className="font-bold lg:font-medium text-[4.5vmin] md:text-[3.4vmin] lg:text-[3.15vmin] 2xl:text-[2.65vmin] font-poppins ">
            {props.details}
          </p>
        </div>
