...
const InternLogin = () => {
  ...
  return (
    <>
      <NavbarGenral />
      <div className="bg-bgColor w-[100vw] h-[90vh] md:h-[85vh] flex  justify-center items-center">
        <div className="card w-[96vw] md:w-[80vmin] 2xl:w-[60vmin] p-8 2xl:p-10 border-lightGrey border-[1px] shadow-2xl">
