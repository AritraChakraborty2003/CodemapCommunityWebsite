  ...
  return (
    <>
      <div className="h-[85vh] w-[100vw] pb-5 overflow-x-hidden bg-bgColor flex justify-center items-center flex-col gap-y-4">
        <div className="mt-[-6vmin] lg:mt-0 flex gap-x-2 items-center h-[20vmin]  md:h-[25vmin] lg:h-[10vmin]  lg:ml-0">
          <div className="h-[4px] w-[19px] border-grey border-b-[1px] hidden lg:block"></div>
          <p className="text-center mt-[-2vmin] text-[4vmin] md:text-[3.3vmin] lg:text-[4vmin] lg:font-medium font-poppins md:pl-2 md:pr-2">
        ...
        <div className="flex gap-x-2 items-center h-[10vmin]">
          <p className="lg:ml-[0.45vmin] text-[4vmin] md:text-[3.85vmin] lg:text-[3.65vmin] font-poppins text-bannerGrey mt-[3vmin]">
