  ...
  return (
    <>
      <div className="supportAreaHolder w-[100vw] bg-bgColor pt-5 pb-10">
        ...
        <div className="supportBoxHolder gap-x-1 lg:gap-x-14 2xl:gap-x-14 gap-y-7 lg:gap-y-5 mt-[10vmin] w-[100vw] flex flex-wrap justify-center items-center pb-6 mt-[-5vmin]">
