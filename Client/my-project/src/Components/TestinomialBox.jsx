...
const TestinomialBox = (props) => {
  return (
    <>
      <div className="boxArea bg-white flex flex-col w-[100vw] md:w-[85vmin] border-[1px] pl-3 pt-[1px] rounded-lg shadow-2xl">
        <div className="row1 flex w-[98vw] pb-1 ">
          <div className="col1">
          ...
          <div className="col2 mt-2">
            <div className="font-poppins space-y-1 detailsBox w-[97vw]  mt-1 text-[2.45vmin]">
