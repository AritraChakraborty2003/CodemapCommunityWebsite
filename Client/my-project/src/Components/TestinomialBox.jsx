...
const TestinomialBox = (props) => {
  return (
    <>
      <div className="Holderarea bg-white flex rounded-lg  pr-1 flex-col gap-y-7 items-center w-[99vw] md:w-[85vw] pl-2 lg:pl-0  h-[125vmin] md:h-[91vmin] mt-4 lg:w-[95vmin] lg:h-[55vmin] border-lightGrey border-[1px]  pb-5">
        {(screen.width <= 1000 && (
          <>
            ...
            <div className="commentArea w-[100%] flex justify-center items-center ml-1">
              <p className="text-[4vmin] tracking-wide ml-1 mt-[-0.5vmin] font-poppins">
                " {props.data.comment} "
              </p>
            </div>
          </>
          ...
          <div className="boxHolder flex flex-col">
            ...
            <div className="row2 border-t-2 h-[30vmin] w-[91vmin] ml-1 flex justify-center ">
              <p className="text-[2.65vmin] lg:text-[3.25vmin] 2xl:text-[2.85vmin] mt-[5vmin]  text-center md:tracking-[1.35px]">
                " {props.data.comment} "
              </p>
            </div>
          </div>
