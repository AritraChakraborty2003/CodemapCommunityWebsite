  ...
  return (
    <>
      <div className="about-area flex justify-center items-center flex-wrap ml-[-2vmin]">
        {(screen.width <= 900 && (
          <>
            <div className="text-area w-[95vw] h-[50vh]  pl-3 flex justify-center items-end md:items-center">
              <div className="imageHolder w-[93vw] h-[45vh] flex justify-center items-end md:items-center">
                <img
                  src="./indiaMap.jpg"
          ...
          (screen.width >= 1280 && screen.width < 1400 && (
            <>
              <div className="text-area w-[100vmin] h-[75vh] flex justify-end items-center">
                <div className="imageHolder w-[80vmin] h-[65vh]">
                  <img
                    src="./indiaMap.jpg"
                    className="max-w-full max-h-full object-contain"
                  ></img>
